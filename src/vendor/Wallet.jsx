          ...
          <div>
            <div className="flex flex-col justify-around items-center mt-16 gap-4">
              <div className="border-2 border-gray-400 w-[95%] md:w-[70%] p-2 md:p-5 bg-white rounded-md">
                <h1 className="text-xl sm:text-2xl font-semibold mb-1 text-center">Current Balance</h1>
                <div className="my-3">
                  <div className="flex justify-center items-center w-full hover:bg-gray-200 p-2 rounded-md gap-4">
                    <div className="w-1/2">
                      <h1 className="text-sm sm:text-lg">Total Sales Amount</h1>
                    </div>
                    <div className="w-1/2 h-full bg-gray-200 hover:bg-white px-2 py-1 rounded-md text-sm sm:text-xl font-semibold">
                      <p>
                  ...
                  <div className="flex justify-center items-center w-full hover:bg-gray-200 p-2 rounded-md gap-4">
                    <div className="w-1/2">
                      <h1 className="text-sm sm:text-lg">Total Commission</h1>
                    </div>
                    <div className="w-1/2 h-full bg-gray-200 hover:bg-white px-2 py-1 rounded-md text-sm sm:text-xl font-semibold">
                      <p>
                  ...
                  <div className="flex justify-center items-center w-full hover:bg-gray-200 p-2 rounded-md gap-4">
                    <div className="w-1/2">
                      <h1 className="text-sm sm:text-lg">Total Balance</h1>
                    </div>
                    <div className="w-1/2 h-full bg-gray-200 hover:bg-white px-2 py-1 rounded-md text-sm sm:text-xl font-semibold">
                      <p>
